...
public class Hud : MonoBehaviour {
	...
	private GameObject popupLevels;
	...
	private void InitPopups () {
		containers.popups.gameObject.SetActive(true);

		popupWin = containers.popups.Find("PopupWin").gameObject;
		popupWin.SetActive(false);

		popupLevels = containers.popups.Find("PopupLevels").gameObject;
		popupLevels.SetActive(false);
	}


	public IEnumerator DisplayPopupWin (bool value, float duration) {
	...
	public void ShowPopupLevels (LevelManager levelManager, string mode) {
		popupLevels.GetComponent<PopupLevels>().Init(this, levelManager, mode);
		popupLevels.SetActive(true);
	}


	public void HidePopupLevels() {
		popupLevels.SetActive(false);
	}
